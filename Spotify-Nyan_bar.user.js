...
// @homepageURL  https://github.com/kitbodega/Nyan-Cat-Progress-Bar-Port
// @updateURL    https://raw.githubusercontent.com/kitbodega/Nyan-Cat-Progress-Bar-Port/main/Spotify-Nyan_bar.user.js
...
(function() {
    ...
    function applyRainbowToFill() {
        ...
        const bg = document.querySelector('[data-testid="progress-bar-background"]');
        if (!bg) return;
